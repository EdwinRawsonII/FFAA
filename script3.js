...
// ENVUELVE TODO TU CÓDIGO ACTUAL ASÍ:
document.addEventListener("DOMContentLoaded", () => {
    ...
    // ... TODAS TUS FUNCIONES (createColumns, animateColumn, etc) ...

    // Al final del archivo, asegúrate de llamar a las ejecuciones dentro:
    createColumns();
    initializeColumns();
